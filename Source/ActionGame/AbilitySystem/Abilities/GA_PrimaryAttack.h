...
protected:
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "PrimaryAttack|Debug")
	bool bDebugDrawTrace = false;

	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "PrimaryAttack|Debug", meta = (ClampMin = "0.0"))
